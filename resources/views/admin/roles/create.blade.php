                        ...
                        <div class="tab-pane {!! $active !!}" id="modulo-{!! $modulo->id !!}">
                            @foreach ($modulo->permisos as $permiso)
                                <div class="form-check">
                                  <input class="form-check-input" id="permiso_{!! $permiso->id !!}" type="checkbox" name="permisos[]" value="{!! $permiso->id !!}" @if(is_array(old('permisos'))) @if (in_array($permiso->id, old('permisos'))) checked @endif @endif>
