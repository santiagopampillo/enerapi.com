...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ url('/home') }}"><img src="{{ asset('images/logo-admin.jpg') }}" width="70%"></a>
    </div>

    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Ingres&aacute; tus datos para iniciar sesi&oacute;n</p>
        ...
        <form method="post" action="{{ route('admin.login.submit') }}">
            ...
            <div class="row">
                <div class="col-xs-8 col-md-5 col-md-offset-0">
		...
		<!--a href="{{ url('/admin/password/email') }}" style="margin-top: 10px">Olvide mi contrase&ntilde;a</a--><br>
