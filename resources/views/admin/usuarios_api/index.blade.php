            ...
            <div class="card collapsed-card card-outline" style="border-top:3px solid #42739e">
                      <div class="card-header">
                                ...
                                <div class="card-tools" >
                                          <a href="{!! route('usuarios_api.create') !!}" class="btn btn-sm" style="background-color: #42739e;border-color: #42739e;color:#fff;">
                              ...
                              <div class="row">
                                <div class="col-4">
                                      <div class="form-group">
                                              <label>Email</label>
                                              <input type="text" id="email" name="email" class="form-control" value="{!! $filtros["email"] !!}">
                                      </div>
                                </div>
                              </div>
            ...
            <div class="card card-default card-outline">
                <div class="card-body" style="padding: 0;">
                        <div class="table-responsive">
                            @include('admin.usuarios_api.table')
