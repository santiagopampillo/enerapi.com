...
class ProcesamientoRepository extends BaseRepository
{
    /**
     * @var array
     */
    ...
    {
        return Procesamiento::class;
    }   

    public function existeProcesamientoPorEstado($anio, $mes, $codigo, $estado){
        //$procesamiento = $this->model->newQuery()->where('anio','=',$anio);
        $procesamiento = Procesamiento::where('anio','=',$anio);
    ...
    public function crearProcesamientoEstado($anio, $mes, $codigo, $estado, $empresa_id, $procesamiento_archivo_id){
        $procesamientoEstado = new Procesamiento;
        ...
        $procesamientoEstado->procesamiento_archivo_id = $procesamiento_archivo_id;
    ...
    public function archivosBajadosSinProcesar($anio, $mes){
        $sinProcesar = Procesamiento::where('anio','=',$anio);
